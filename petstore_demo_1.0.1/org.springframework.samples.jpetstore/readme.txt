...
-------------------------------
Modifs Agnès :
1. Spring version : 3.0.0.BUILD-SNAPSHOT --> 3.0.3.RELEASE
2. Ajout dépendance à org.slf4j:slf4j-simple:1.5.8
3. Ajout jetty-maven-plugin
4. Ajout exec plugin dans pom principal pour démarrage db
5. Suppression des valeurs pré-remplies dans les champs login et mot-de-passe